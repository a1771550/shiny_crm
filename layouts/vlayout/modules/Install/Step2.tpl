...
<div class="row-fluid main-container">
	<div class="inner-container">
		<div class="row-fluid">
			...
			<div class="span2">
				<a href="https://wiki.smartsymbolglobal.com/vtiger6/" target="_blank" class="pull-right">
		...
		<form class="form-horizontal" name="step2" method="get" action="index.php">
			...
			<div class="span12">
				...
				<div class="lic-scroll">
					...
					<br>
					The smartsymbol Public License Version 1.2 is based on the Mozilla Public License Version 1.1 with the additional terms in Exhibit B. The original Mozilla Public License 1.1 can be found at: http://www.mozilla.org/MPL/MPL-1.1.html
					<br>
					smartsymbol Public License
					Version 1.2
					<br><br>
					Copyright (c) 2004-2013 www.smartsymbolglobal.com All rights reserved.
					<br><br>
					<!--
     ...
     smartsymbol may publish revised and/or new versions of the License from time to time. Each version will be given a distinguishing version number. 

						</dd><br><dd>      6.2. Effect of New Versions.
      Once Covered Code has been published under a particular version of the License, You may always continue to use it under the terms of that version. You may also choose to use such Covered Code under the terms of any subsequent version of the License published by smartsymbol. No one other than smartsymbol has the right to modify the terms applicable to Covered Code created under this License.

						</dd><br><dd>    6.3. Derivative Works.
     If You create or use a modified version of this License (which you may only do in order to apply it to code which is not already Covered Code governed by this License), You must (a) rename Your license so that the phrases "smartsymbol'or any confusingly similar phrase do not appear in your license (except to note that your license differs from this License) and (b) otherwise make it clear that Your version of the license contains terms which differ from the smartsymbol Public License. (Filling in the name of the Initial Developer, Original Code or Contributor in the notice described in Exhibit A shall not of themselves be deemed to be modifications of this License.)
						</dd></dl><br>
					</li><li>
					...
					EXHIBIT A -smartsymbol Public License.
					<br><br>
					"The contents of this file are subject to the smartsymbol Public License Version 1.1 (the "License"); you may not use this file except in compliance with the License."
					<br><br>
					Software distributed under the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF ANY KIND, either express or implied. See the License for the specific language governing rights and limitations under the License.
					<br><br>
					The Original Code is smartsymbol.
					<br><br>
					The Initial Developer of the Original Code is smartsymbol. Portions created by  smartsymbol are Copyright (C) www.smartsymbolglobal.com. All Rights Reserved.
					<br><br>
