...
class DefaultDataPopulator extends CRMEntity {
	...
	function create_tables() {
		...
		$this->db->query("insert into vtiger_field values (14," . $this->db->getUniqueID("vtiger_field") . ",'cost','vtiger_products',1,'72','cost','Cost',1,2,'',100,3,32,1,'N~O',2,3,'BAS',0)");
...
//insert into email template vtiger_table
		...
		$body = 'Hello!   <br />
	<br />
	On behalf of the smartsymbol team,  I am pleased to announce the release of smartsymbol crm4.2 . This is a feature packed release including the mass email template handling, custom view feature, vtiger_reports feature and a host of other utilities. smartsymbol runs on all platforms.    <br />
        <br />
	Notable Features of smartsymbol are :   <br />
	<br />
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: rgb(27, 77, 140); font-family: Arial,Helvetica,sans-serif; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; line-height: 25px;">
                                ...
                                <tr>
                                    <td align="left" style="background-color: rgb(27, 77, 140); font-family: Arial,Helvetica,sans-serif; font-size: 24px; color: rgb(255, 255, 255); font-weight: bolder; line-height: 35px;">smartsymbol CRM<br /> </td>
                                </tr>
                                <tr>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; font-weight: normal; color: rgb(0, 0, 0); background-color: rgb(255, 255, 255);">
                                <tr>
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="5" border="0">
                                            ...
                                            <tr>
                                                <td style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; color: rgb(0, 0, 0); font-weight: normal; text-align: justify; line-height: 20px;"> Thank you very much for subscribing to the smartsymbol CRM - annual support service.<br />Here is your self service portal login details:</td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                            ...
                                            <tr>
                                                <td style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; color: rgb(0, 0, 0); font-weight: normal; text-align: justify; line-height: 20px;"><strong>NOTE:</strong> We suggest you to change your password after logging in first time. <br /><br /> <strong><u>Help Documentation</u></strong><br />  <br /> After logging in to smartsymbol Self-service Portal first time, you can access the smartsymbol CRM documents from the <strong>Documents</strong> tab. Following documents are available for your reference:<br />
                                                <ul>
                                                    <li>Installation Manual (Windows &amp; Linux OS)<br /> </li>
                                                    <li>User &amp; Administrator Manual<br /> </li>
                                                    <li>smartsymbol Customer Portal - User Manual<br /> </li>
                                                    <li>smartsymbol Outlook Plugin - User Manual<br /> </li>
                                                    <li>smartsymbol Office Plug-in - User Manual<br /> </li>
                                                    <li>smartsymbol Thunderbird Extension - User Manual<br /> </li>
                                                    <li>smartsymbol Web Forms - User Manual<br /> </li>
                                                    <li>smartsymbol Firefox Tool bar - User Manual<br /> </li>
                                                </ul>
                                                <br />  <br /> <strong><u>Knowledge Base</u></strong><br /> <br /> Periodically we update frequently asked question based on our customer experiences. You can access the latest articles from the <strong>FAQ</strong> tab.<br /> <br /> <strong><u>smartsymbol CRM - Details</u></strong><br /> <br /> Kindly let us know your current smartsymbol CRM version and system specification so that we can provide you necessary guidelines to enhance your smartsymbol CRM system performance. Based on your system specification we alert you about the latest security &amp; upgrade patches.<br />  <br />			 Thank you once again and wish you a wonderful experience with smartsymbol CRM.<br /> </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="right"><a style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; font-weight: bolder; text-decoration: none; color: rgb(66, 66, 253);" href="http://www.smartsymbolglobal.com">www.smartsymbolglobal.com</a></td>
                                            </tr>
                                            <tr>
                                                <td> </td>
                                            </tr>
                    ...
                    <tr>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="5" border="0" style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; color: rgb(255, 255, 255); font-weight: normal; line-height: 15px; background-color: rgb(51, 51, 51);">
                                ...
                                <tr>
                                    <td align="center">Email Id: <a style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; font-weight: bolder; text-decoration: none; color: rgb(255, 255, 255);" href="mailto:support@smartsymbolglobal.com">support@smartsymbolglobal.com</a></td>
                                </tr>
                        </table>
                        </td>
                    </tr>
...
//for Support end notification before a week
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: rgb(27, 77, 140); font-family: Arial,Helvetica,sans-serif; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; line-height: 25px;">
                                ...
                                <tr>
                                    <td align="left" style="background-color: rgb(27, 77, 140); font-family: Arial,Helvetica,sans-serif; font-size: 24px; color: rgb(255, 255, 255); font-weight: bolder; line-height: 35px;">smartsymbol CRM </td>
                                </tr>
                                <tr>
                                    <td align="right" style="padding-right: 100px;">The honest Open Source CRM </td>
                                </tr>
                    ...
                    <tr>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="5" border="0" style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; color: rgb(255, 255, 255); font-weight: normal; line-height: 15px; background-color: rgb(51, 51, 51);">
                                ...
                                <tr>
                                    <td align="center">Email Id: <a style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; font-weight: bolder; text-decoration: none; color: rgb(255, 255, 255);" href="mailto:info@smartsymbolglobal.com">info@smartsymbolglobal.com</a></td>
                                </tr>
                        </table>
                        </td>
                    </tr>
		...
		$this->db->query("insert into vtiger_emailtemplates(foldername,templatename,subject,description,body,deleted,templateid) values ('Public','Support end notification before a week','SmartSymbolCRM Support Notification','Send Notification mail to customer before a week of support end date','" . $body . "',0," . $this->db->getUniqueID('vtiger_emailtemplates') . ")");
...
//for Support end notification before a month
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; font-weight: normal; color: rgb(0, 0, 0); background-color: rgb(255, 255, 255);">
                                <tr>
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="5" border="0">
                                            ...
                                            <tr>
                                                <td style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; color: rgb(0, 0, 0); font-weight: normal; text-align: justify; line-height: 20px;">This is just a notification mail regarding your support end.<br /><span style="font-weight: bold;">Priority:</span> Normal<br />Your Support is going to expire on next month.<br />Please contact support@smartsymbolglobal.com<br /><br /><br /></td>
                                            </tr>
                                            <tr>
                                                <td align="center"><br /></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="right"><a href="http://www.smartsymbolglobal.com" style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; font-weight: bolder; text-decoration: none; color: rgb(66, 66, 253);">www.smartsymbolglobal.com</a></td>
                                            </tr>
                                            <tr>
                                                <td> </td>
                                            </tr>
                    ...
                    <tr>
                        ...
                        <table width="100%" cellspacing="0" cellpadding="5" border="0" style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; color: rgb(255, 255, 255); font-weight: normal; line-height: 15px; background-color: rgb(51, 51, 51);">
                                ...
                                <tr>
                                    <td align="center">Email Id: <a href="mailto:info@smartsymbolglobal.com" style="font-family: Arial,Helvetica,sans-serif; font-size: 12px; font-weight: bolder; text-decoration: none; color: rgb(255, 255, 255);">info@smartsymbolglobal.com</a></td>
                                </tr>
                        </table>
                        </td>
                    </tr>
		...
		$this->db->query("insert into vtiger_emailtemplates(foldername,templatename,subject,description,body,deleted,templateid) values ('Public','Support end notification before a month','SmartSymbolCRM Support Notification','Send Notification mail to customer before a month of support end date','" . $body . "',0," . $this->db->getUniqueID('vtiger_emailtemplates') . ")");
		...
		$this->db->query("insert into vtiger_organizationdetails(organization_id,organizationname,address,city,state,country,code,phone,fax,website,logoname,vatid)
								values ($organizationId,'smartsymbol','95, 12th Main Road, 3rd Block, Rajajinagar','Bangalore',
										'Karnataka','India','560010','+91 9243602352','+91 9243602352','www.smartsymbolglobal.com','smartsymbol-crm-logo.png','1234-5678-9012')");
