...
class Import_Data_Action extends Vtiger_Action_Controller {
	...
	public static function runScheduledImport() {
		...
		foreach ($scheduledImports as $scheduledId => $importDataController) {
			...
			$emailSubject = 'smartsymbol CRM - Scheduled Import Report for '.$importDataController->module;
			...
			$emailData = 'smartsymbol CRM has just completed your import process. <br/><br/>' .
							$importResult . '<br/><br/>'.
