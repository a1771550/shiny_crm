...
class Services extends CRMEntity {
	...
	*/
	 ...
	 *	@param string $tablename - vtiger_tablename to save the service currency relationship (productcurrencyrel)
	 *	@param string $module	 - current module name
	 *	$return void
	*/
	 ...
	 *	@param string $tablename - vtiger_tablename to save the service currency relationship (productcostrel)
	 *	@param string $module	 - current module name
	 *	$return void
	 */
