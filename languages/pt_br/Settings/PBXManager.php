 ...
 * Portions created by smartsymbol are Copyright (C) smartsymbol. All Rights Reserved
...
$languageStrings = array(
    ...
    'LBL_INFO_CONTEXT' => 'Contexto Específico do Smart Symbol configurado no seu servidro Asterisk (extensions.conf)',
    'LBL_PBXMANAGER_INFO' => 'Configure os Detalhes do Servidor Asterisk acima, somente depois de instalar o Conector do Smart Symbol em seu Servidor Asterisk.',
    
    'webappurl'=>'URL do Smart Symbol Asterisk',
    'vtigersecretkey'=>'Chave Secreta Smart Symbol',
